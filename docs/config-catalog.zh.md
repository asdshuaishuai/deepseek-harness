...
来源：[`packages/compaction/compaction-sliding/src/index.ts:35`](../packages/compaction/compaction-sliding/src/index.ts)
...
来源：[`packages/web/web-search-stepfun/src/index.ts:42`](../packages/web/web-search-stepfun/src/index.ts)
