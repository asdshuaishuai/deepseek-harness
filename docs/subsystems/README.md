...
| [voice.md](voice.md) | duplex voice: the realtime transport (`ctx.stepfunRealtime`), the transcript-to-agent bridge (`ctx.voiceAgent`), channels and the realtime model |
