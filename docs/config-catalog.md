...
Source: [`packages/llm/llm-stepfun/src/config.ts:33`](../packages/llm/llm-stepfun/src/config.ts)
...
Source: [`packages/mcp/mcp-stepfun-search/src/index.ts:50`](../packages/mcp/mcp-stepfun-search/src/index.ts)
...
Source: [`packages/voice/stepfun-realtime/src/index.ts:65`](../packages/voice/stepfun-realtime/src/index.ts)
...
Requires: `stepfunRealtime` · `agents` · `sessions` · `agentDefaultModel`
...
Source: [`packages/voice/voice-agent/src/index.ts:33`](../packages/voice/voice-agent/src/index.ts)
...
- `@deepseek-ai/dsh-voice-app` — requires `voiceAgent` · `voiceStartup` ([`packages/bundle/voice-app/src/index.ts`](../packages/bundle/voice-app/src/index.ts))
