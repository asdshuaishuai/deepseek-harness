...
Source: [`packages/voice/stepfun-realtime/src/index.ts:72`](../packages/voice/stepfun-realtime/src/index.ts)
...
Requires: `webServer` · `connection` · `voiceAgent` · `stepfunRealtime`
