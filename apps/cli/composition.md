...
flowchart LR
  ...
  plugin_dsh_base_stepfun_search_mcp["stepfun-search-mcp<br/>@deepseek-ai/dsh-mcp-stepfun-search"]
  cfg --> plugin_dsh_base_stepfun_search_mcp
  ...
  plugin_dsh_base_llm_stepfun["llm-stepfun<br/>@deepseek-ai/dsh-llm-stepfun"]
  cfg --> plugin_dsh_base_llm_stepfun
```
