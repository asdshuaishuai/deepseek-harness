...
export const en = {
  ...
  stepfunChannel: 'Billing channel',
  stepfunChannelStandard: 'Open platform (pay-as-you-go)',
  stepfunChannelPlan: 'Step Plan subscription',
  stepfunChannelHint: 'Switching also swaps the built-in catalog (Step 3.7 Flash, Step 3.5 Flash family, Step Router).',
  stepfunEndpoints: 'API endpoint (built-in)',
  stepfunBaseUrlStandard: 'https://api.stepfun.com/v1',
  stepfunBaseUrlPlan: 'https://api.stepfun.com/step_plan/v1',
  stepfunEndpointsHint: 'Both are the platform standard endpoints; the billing channel selects between them. A private gateway sets llm-stepfun.baseURL in settings.yaml.',
  models: 'Models',
  ...
  onboardingDescription: 'Configure the official {provider} provider to start building.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  stepfunChannel: '计费通道',
  stepfunChannelStandard: '开放平台（按量计费）',
  stepfunChannelPlan: 'Step Plan 订阅',
  stepfunChannelHint: '切换会同时更换内置目录（Step 3.7 Flash、Step 3.5 Flash 系列、Step Router）。',
  stepfunEndpoints: 'API 地址（内置）',
  stepfunBaseUrlStandard: 'https://api.stepfun.com/v1',
  stepfunBaseUrlPlan: 'https://api.stepfun.com/step_plan/v1',
  stepfunEndpointsHint: '两个地址均为平台标准端点，随计费通道切换；自建网关请在 settings.yaml 中设置 llm-stepfun.baseURL。',
  models: '模型目录',
  ...
  onboardingDescription: '配置 {provider} 官方模型，即可开始使用。',
