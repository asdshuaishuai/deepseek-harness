...
export const en = {
  ...
  stepfunEndpoint: 'API endpoint (built-in)',
  stepfunBaseUrlStandard: 'https://api.stepfun.com/v1',
  stepfunBaseUrlPlan: 'https://api.stepfun.com/step_plan/v1',
  stepfunEndpointSibling: 'The other endpoint is a separate provider:',
  stepfunEndpointsHint: 'Endpoints are platform standards and read-only; the two StepFun endpoints are independent providers with their own key and catalog. A private gateway sets this section\'s baseURL in settings.yaml.',
  models: 'Models',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  stepfunEndpoint: 'API 地址（内置）',
  stepfunBaseUrlStandard: 'https://api.stepfun.com/v1',
  stepfunBaseUrlPlan: 'https://api.stepfun.com/step_plan/v1',
  stepfunEndpointSibling: '另一端点（独立提供商条目）：',
  stepfunEndpointsHint: '端点为平台标准地址、只读；两个 StepFun 端点是独立的提供商，各有自己的密钥与模型目录。自建网关请在 settings.yaml 中设置本分节的 baseURL。',
  models: '模型目录',
