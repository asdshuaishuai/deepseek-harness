...
export const zh = {
  ...
  'option.step5Preview.description': '旗舰智能体模型：支持文本与图像输入、100 万 token 上下文、自动思考，工具调用能力强。',
...
export const en = {
  ...
  'option.step5Preview.description': 'Flagship agentic model: text and image input, 1M-token context, automatic thinking, strong tool use.',
