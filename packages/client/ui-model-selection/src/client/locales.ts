...
export const zh = {
  ...
  'option.step5Preview.description': '旗舰智能体模型：支持文本与图像输入、100 万 token 上下文、可选推理强度，工具调用能力强。',
  'option.step3.description': '纯文本通用模型，适合更轻量或对成本更敏感的对话。',
...
export const en = {
  ...
  'option.step5Preview.description': 'Flagship agentic model: text and image input, 1M-token context, selectable reasoning efforts, strong tool use.',
  'option.step3.description': 'Text-only general model for lighter or cost-sensitive turns.',
