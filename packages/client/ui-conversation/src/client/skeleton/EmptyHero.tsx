...
/**
 * Render the hero chrome (headline only; no composer, no workspace row). The
 * upstream animated brand fish is not drawn here: this fork's hero is text
 * alone, and a brand package may still occupy `conversation.hero.brand.mark`
 * to place its own mark before the headline.
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {renderSlot('conversation.hero.brand.mark', { size: 34, className: css.fish }, { fallback: null })}
