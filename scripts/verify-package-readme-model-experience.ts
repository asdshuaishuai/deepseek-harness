...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/voice/voice-web-bridge': { kind: 'indirect', reason: 'The bridge forwards microphone bytes and conversation events verbatim; the voice agent owns every model-visible request and answer.' },
  ...
  'packages/web/web-search-stepfun': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-web.' },
